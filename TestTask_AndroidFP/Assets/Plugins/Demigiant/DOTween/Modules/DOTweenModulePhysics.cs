...
namespace DG.Tweening
{
	public static class DOTweenModulePhysics
	{
        ...
        public static TweenerCore<Vector3, Vector3, VectorOptions> DOMove(
			...
			bool snapping = false)
		{
			var t = DOTween.To(() => target.position,
				target.MovePosition,
				endValue,
				duration);
		...
		{
			var t = DOTween.To(() => target.rotation,
				target.MoveRotation,
				endValue,
				duration);
			...
			bool snapping = false)
		{
			...
			Tween yTween = DOTween.To(() => target.position,
					target.MovePosition,
			...
			s.Append(DOTween.To(() => target.position,
						target.MovePosition,
						new Vector3(endValue.x, 0, 0),
						duration)
					.SetOptions(AxisConstraint.X, snapping)
					.SetEase(Ease.Linear))
				.Join(DOTween.To(() => target.position,
						target.MovePosition,
			...
			Color? gizmoColor = null)
		{
			...
			var t = DOTween.To(PathPlugin.Get(),
					() => target.position,
					target.MovePosition,
					new Path(pathType,
						path,
