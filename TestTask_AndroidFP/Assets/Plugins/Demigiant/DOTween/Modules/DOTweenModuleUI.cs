	...
	public static class DOTweenModuleUI
	{
		...
		public static class Utils
		{
            ...
            public static Vector2 SwitchToRectTransform(RectTransform from, RectTransform to)
			{
				...
				RectTransformUtility.ScreenPointToLocalPointInRectangle(to,
					screenP,
					null,
					out localPoint);
		...
		{
			var t = DOTween.ToAlpha(() => target.color,
				x => target.color = x,
				endValue,
				duration);
        ...
        public static TweenerCore<float, float, FloatOptions> DOFillAmount(this Image target, float endValue, float duration)
		{
			...
			var t = DOTween.To(() => target.fillAmount,
        ...
        public static TweenerCore<Vector2, Vector2, VectorOptions> DOFlexibleSize(
			...
			bool snapping = false)
		{
			var t = DOTween.To(() => new Vector2(target.flexibleWidth, target.flexibleHeight),
				x =>
				{
        ...
        public static TweenerCore<Vector2, Vector2, VectorOptions> DOMinSize(
			...
			bool snapping = false)
		{
			var t = DOTween.To(() => new Vector2(target.minWidth, target.minHeight),
				x =>
				{
					target.minWidth = x.x;
        ...
        public static TweenerCore<Vector2, Vector2, VectorOptions> DOPreferredSize(
			...
			bool snapping = false)
		{
			var t = DOTween.To(() => new Vector2(target.preferredWidth, target.preferredHeight),
				x =>
				{
		...
		{
			var t = DOTween.To(() => target.effectColor,
		...
		{
			var t = DOTween.ToAlpha(() => target.effectColor,
				x => target.effectColor = x,
				endValue,
				duration);
		...
		{
			var t = DOTween.To(() => target.effectDistance,
        ...
        public static TweenerCore<Vector2, Vector2, VectorOptions> DOAnchorPos(
			...
			bool snapping = false)
		{
			var t = DOTween.To(() => target.anchoredPosition,
        ...
        public static TweenerCore<Vector3, Vector3, VectorOptions> DOAnchorPos3D(
			...
			bool snapping = false)
		{
			var t = DOTween.To(() => target.anchoredPosition3D,
        ...
        public static TweenerCore<Vector2, Vector2, VectorOptions> DOAnchorMax(
			...
			bool snapping = false)
		{
			var t = DOTween.To(() => target.anchorMax,
        ...
        public static TweenerCore<Vector2, Vector2, VectorOptions> DOAnchorMin(
			...
			bool snapping = false)
		{
			var t = DOTween.To(() => target.anchorMin,
        ...
        public static TweenerCore<Vector2, Vector2, VectorOptions> DOSizeDelta(
			...
			bool snapping = false)
		{
			var t = DOTween.To(() => target.sizeDelta,
        ...
        public static Tweener DOPunchAnchorPos(
			...
			bool snapping = false)
		{
			return DOTween.Punch(() => target.anchoredPosition,
					x => target.anchoredPosition = x,
					punch,
					duration,
					vibrato,
		...
		{
			return DOTween.Shake(() => target.anchoredPosition,
					x => target.anchoredPosition = x,
					duration,
					strength,
					vibrato,
			...
			bool snapping = false)
		{
			...
			var s = DOTween.Sequence();
			Tween yTween = DOTween.To(() => target.anchoredPosition,
					x => target.anchoredPosition = x,
			...
			s.Append(DOTween.To(() => target.anchoredPosition,
						x => target.anchoredPosition = x,
        ...
        public static Tweener DOHorizontalNormalizedPos(
			...
			bool snapping = false)
		{
			return DOTween.To(() => target.horizontalNormalizedPosition,
        ...
        public static Tweener DOVerticalNormalizedPos(
			...
			bool snapping = false)
		{
			return DOTween.To(() => target.verticalNormalizedPosition,
        ...
        public static TweenerCore<Vector2, Vector2, CircleOptions> DOShapeCircle(
			...
			bool snapping = false)
		{
			var t = DOTween.To(CirclePlugin.Get(),
