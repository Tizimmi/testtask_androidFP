namespace Zenject
{
		...
		where TDerived : Installer<TParam1, TDerived>
	{
		...
		{
			container.InstantiateExplicit<TDerived>(InjectUtil.CreateArgListExplicit(p1)).InstallBindings();
		}
	}
		...
		where TDerived : Installer<TParam1, TParam2, TDerived>
	{
		...
		{
			container.InstantiateExplicit<TDerived>(InjectUtil.CreateArgListExplicit(p1, p2)).InstallBindings();
		}
	}
		...
		where TDerived : Installer<TParam1, TParam2, TParam3, TDerived>
	{
		public static void Install(
			...
			TParam3 p3)
		{
			container.InstantiateExplicit<TDerived>(InjectUtil.CreateArgListExplicit(p1, p2, p3)).InstallBindings();
		}
	}
		...
		where TDerived : Installer<TParam1, TParam2, TParam3, TParam4, TDerived>
	{
		public static void Install(
			...
			TParam4 p4)
		{
			container.InstantiateExplicit<TDerived>(InjectUtil.CreateArgListExplicit(p1,
					p2,
					p3,
					p4))
				.InstallBindings();
