...
namespace Zenject
{
	...
	public abstract class SubContainerCreatorByNewPrefabDynamicContext : SubContainerCreatorDynamicContext
	{
		...
		protected override GameObject CreateGameObject(InjectContext context, out bool shouldMakeActive)
		{
			...
			var gameObj = Container.CreateAndParentPrefab(prefab,
				_gameObjectBindInfo,
				null,
	...
	public class SubContainerCreatorByNewPrefabInstaller : SubContainerCreatorByNewPrefabDynamicContext
	{
		...
		{
			context.AddNormalInstaller(new ActionInstaller(subContainer =>
			{
				...
				var installer = (InstallerBase) subContainer.InstantiateExplicit(_installerType, extraArgs);
	...
	public class SubContainerCreatorByNewPrefabMethod<TParam1> : SubContainerCreatorByNewPrefabDynamicContext
	{
		...
		protected override void AddInstallers(List<TypeValuePair> args, GameObjectContext context)
		{
			...
			context.AddNormalInstaller(new ActionInstaller(subContainer => { _installerMethod(subContainer, (TParam1) args[0].Value); }));
		}
	}
	...
	[NoReflectionBaking]
	public class
		SubContainerCreatorByNewPrefabMethod<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6> : SubContainerCreatorByNewPrefabDynamicContext
	{
		readonly
#if !NET_4_6
			ModestTree.Util.
	...
	[NoReflectionBaking]
	public class SubContainerCreatorByNewPrefabMethod<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TParam7, TParam8, TParam9,
		TParam10> : SubContainerCreatorByNewPrefabDynamicContext
	{
		readonly
#if !NET_4_6
			ModestTree.Util.
