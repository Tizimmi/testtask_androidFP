...
namespace Zenject
{
		...
		where TMemoryPool : MemoryPool<TParam1, TParam2, TParam3, IMemoryPool, TContract>
	{
			...
			List<object> buffer)
		{
			...
			buffer.Add(_pool.Spawn((TParam1) args[0].Value,
	...
	[NoReflectionBaking]
	public class
		PoolableMemoryPoolProvider<TParam1, TParam2, TParam3, TParam4, TParam5, TContract, TMemoryPool> : PoolableMemoryPoolProviderBase<TContract>,
		IValidatable
	...
	[NoReflectionBaking]
	public class
		PoolableMemoryPoolProvider<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TContract, TMemoryPool> :
