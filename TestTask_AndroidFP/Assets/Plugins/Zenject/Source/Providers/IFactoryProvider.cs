...
namespace Zenject
{
	...
	public class IFactoryProvider<TParam1, TParam2, TParam3, TContract> : IFactoryProviderBase<TContract>
	{
			...
			List<object> buffer)
		{
			...
			if (Container.IsValidating)
				...
				buffer.Add(((IFactory<TParam1, TParam2, TParam3, TContract>) factory).Create((TParam1) args[0].Value,
	...
	public class IFactoryProvider<TParam1, TParam2, TParam3, TParam4, TContract> : IFactoryProviderBase<TContract>
	{
			...
			List<object> buffer)
		{
			...
			if (Container.IsValidating)
				...
				buffer.Add(((IFactory<TParam1, TParam2, TParam3, TParam4, TContract>) factory).Create((TParam1) args[0].Value,
					(TParam2) args[1].Value,
					(TParam3) args[2].Value,
	...
	public class IFactoryProvider<TParam1, TParam2, TParam3, TParam4, TParam5, TContract> : IFactoryProviderBase<TContract>
	{
			...
			List<object> buffer)
		{
			...
			if (Container.IsValidating)
				...
				buffer.Add(((IFactory<TParam1, TParam2, TParam3, TParam4, TParam5, TContract>) factory).Create((TParam1) args[0].Value,
					(TParam2) args[1].Value,
					(TParam3) args[2].Value,
					(TParam4) args[3].Value,
	...
	public class IFactoryProvider<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TContract> : IFactoryProviderBase<TContract>
	{
			...
			List<object> buffer)
		{
			...
			if (Container.IsValidating)
				...
				buffer.Add(((IFactory<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TContract>) factory).Create((TParam1) args[0].Value,
					(TParam2) args[1].Value,
					(TParam3) args[2].Value,
					(TParam4) args[3].Value,
					(TParam5) args[4].Value,
	...
	[NoReflectionBaking]
	public class IFactoryProvider<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TParam7, TParam8, TParam9, TParam10,
		TContract> : IFactoryProviderBase<TContract>
	{
			...
			List<object> buffer)
		{
			...
			var factory = Container.ResolveId(
				typeof(IFactory<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TParam7, TParam8, TParam9, TParam10, TContract>),
				FactoryId);
