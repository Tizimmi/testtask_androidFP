...
namespace Zenject
{
	...
	public class ConcreteBinderGeneric<TContract> : FromBinderGeneric<TContract>
	{
		...
		public FromBinderGeneric<TContract> ToSelf()
		{
			...
			(container, type) => new TransientProvider(type,
				container,
				BindInfo.Arguments,
		...
		public FromBinderNonGeneric To(Action<ConventionSelectTypesBinder> generator)
		{
			...
			bindInfo.AddTypeFilter(concreteType => BindInfo.ContractTypes.All(contractType => concreteType.DerivesFromOrEqual(contractType)));
