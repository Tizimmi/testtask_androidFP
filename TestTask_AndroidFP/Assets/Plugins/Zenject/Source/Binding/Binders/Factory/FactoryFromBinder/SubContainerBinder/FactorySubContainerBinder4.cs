	...
	public class FactorySubContainerBinder<TParam1, TParam2, TParam3, TParam4, TContract> : FactorySubContainerBinderWithParams<TContract>
	{
				...
				Action<DiContainer, TParam1, TParam2, TParam3, TParam4> installerMethod)
		{
			...
			ProviderFunc = (container) => new SubContainerDependencyProvider(ContractType,
				SubIdentifier,
				new SubContainerCreatorByMethod<TParam1, TParam2, TParam3, TParam4>(container, subcontainerBindInfo, installerMethod),
				false);
				...
				Action<DiContainer, TParam1, TParam2, TParam3, TParam4> installerMethod)
		{
			...
			ProviderFunc = (container) => new SubContainerDependencyProvider(ContractType,
				SubIdentifier,
				new SubContainerCreatorByNewGameObjectMethod<TParam1, TParam2, TParam3, TParam4>(container, gameObjectInfo, installerMethod),
				false);
				...
				Action<DiContainer, TParam1, TParam2, TParam3, TParam4> installerMethod)
		{
			...
			ProviderFunc = (container) => new SubContainerDependencyProvider(ContractType,
				SubIdentifier,
				new SubContainerCreatorByNewPrefabMethod<TParam1, TParam2, TParam3, TParam4>(container,
