	...
	public class FactorySubContainerBinderBase<TContract>
	{
		...
		public ScopeConcreteIdArgConditionCopyNonLazyBinder ByInstaller(Type installerType)
		{
			...
			ProviderFunc = (container) => new SubContainerDependencyProvider(ContractType,
				SubIdentifier,
				new SubContainerCreatorByInstaller(container,
		...
		public NameTransformScopeConcreteIdArgConditionCopyNonLazyBinder ByNewGameObjectInstaller(Type installerType)
		{
			...
			ProviderFunc = (container) => new SubContainerDependencyProvider(ContractType,
				SubIdentifier,
				new SubContainerCreatorByNewGameObjectInstaller(container,
					gameObjectInfo,
					installerType,
					BindInfo.Arguments),
				false);
			...
			Type installerType)
		{
			...
			ProviderFunc = (container) => new SubContainerDependencyProvider(ContractType,
				SubIdentifier,
				new SubContainerCreatorByNewPrefabInstaller(container,
