...
namespace Zenject
{
	...
	public class FactoryFromBinder<TParam1, TParam2, TParam3, TContract> : FactoryFromBinderBase
	{
		...
		{
			ProviderFunc = (container) => new MethodProviderWithContainer<TParam1, TParam2, TParam3, TContract>(method);
		...
		{
			return new FactorySubContainerBinder<TParam1, TParam2, TParam3, TContract>(BindContainer,
				BindInfo,
				FactoryBindInfo,
				subIdentifier);
		}
	...
	public static class FactoryFromBinder3Extensions
	{
			...
			Action<ConcreteBinderGeneric<IFactory<TParam1, TParam2, TParam3, TContract>>> factoryBindGenerator)
		{
			...
			fromBinder.ProviderFunc = (container) => { return new IFactoryProvider<TParam1, TParam2, TParam3, TContract>(container, factoryId); };
		...
		{
			return fromBinder
				.FromPoolableMemoryPool<TParam1, TParam2, TParam3, TContract, PoolableMemoryPool<TParam1, TParam2, TParam3, IMemoryPool, TContract>>(
					poolBindGenerator);
		}
			...
			where TMemoryPool : MemoryPool<TParam1, TParam2, TParam3, IMemoryPool, TContract>
		{
			...
			{
				return new PoolableMemoryPoolProvider<TParam1, TParam2, TParam3, TContract, TMemoryPool>(container, poolId);
			};
