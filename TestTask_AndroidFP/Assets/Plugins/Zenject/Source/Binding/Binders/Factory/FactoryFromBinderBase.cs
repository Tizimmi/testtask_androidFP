...
namespace Zenject
{
	...
	public class FactoryFromBinderBase : ScopeConcreteIdArgConditionCopyNonLazyBinder
	{
		...
		{
			get => FactoryBindInfo.ProviderFunc;
			...
			: base(bindInfo)
		{
			...
			factoryBindInfo.ProviderFunc = (container) => new TransientProvider(ContractType,
				container,
				BindInfo.Arguments,
		...
		public ConditionCopyNonLazyBinder FromInstance(object instance)
		{
			...
			ProviderFunc = (container) => new InstanceProvider(ContractType,
				instance,
				container,
				null);
		...
		{
			ProviderFunc = (container) => new ResolveProvider(ContractType,
				container,
				subIdentifier,
				false,
				InjectSources.Any,
		...
		public ConditionCopyNonLazyBinder FromComponentOn(GameObject gameObject)
		{
			...
			ProviderFunc = (container) => new GetFromGameObjectComponentProvider(ContractType, gameObject, true);
		...
		public ConditionCopyNonLazyBinder FromComponentOn(Func<InjectContext, GameObject> gameObjectGetter)
		{
			...
			ProviderFunc = (container) => new GetFromGameObjectGetterComponentProvider(ContractType, gameObjectGetter, true);
		...
		{
			return FromComponentOn(ctx => BindContainer.Resolve<Context>().gameObject);
		}
		...
		public ConditionCopyNonLazyBinder FromNewComponentOn(GameObject gameObject)
		{
			...
			ProviderFunc = (container) => new AddToExistingGameObjectComponentProvider(gameObject,
				container,
				ContractType,
		...
		public ConditionCopyNonLazyBinder FromNewComponentOn(Func<InjectContext, GameObject> gameObjectGetter)
		{
			...
			ProviderFunc = (container) => new AddToExistingGameObjectComponentProviderGetter(gameObjectGetter,
				container,
				ContractType,
				new List<TypeValuePair>(),
				BindInfo.ConcreteIdentifier,
		...
		public NameTransformScopeConcreteIdArgConditionCopyNonLazyBinder FromNewComponentOnNewGameObject()
		{
			...
			ProviderFunc = (container) => new AddToNewGameObjectComponentProvider(container,
				ContractType,
				new List<TypeValuePair>(),
				gameObjectInfo,
				BindInfo.ConcreteIdentifier,
		...
		public NameTransformScopeConcreteIdArgConditionCopyNonLazyBinder FromNewComponentOnNewPrefab(UnityEngine.Object prefab)
		{
			...
			ProviderFunc = (container) => new InstantiateOnPrefabComponentProvider(ContractType,
				new PrefabInstantiator(container,
					gameObjectInfo,
					ContractType,
					new[] {ContractType},
					new List<TypeValuePair>(),
		...
		public NameTransformScopeConcreteIdArgConditionCopyNonLazyBinder FromComponentInNewPrefab(UnityEngine.Object prefab)
		{
			...
			ProviderFunc = (container) => new GetFromPrefabComponentProvider(ContractType,
				new PrefabInstantiator(container,
					gameObjectInfo,
					ContractType,
					new[] {ContractType},
		...
		public ConditionCopyNonLazyBinder FromNewScriptableObjectResource(string resourcePath)
		{
			...
			ProviderFunc = (container) => new ScriptableObjectResourceProvider(resourcePath,
				ContractType,
				container,
				new List<TypeValuePair>(),
				true,
		...
		public ConditionCopyNonLazyBinder FromResource(string resourcePath)
		{
			...
			ProviderFunc = (container) => new ResourceProvider(resourcePath, ContractType, true);
